  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-24 sm:px-6 sm:py-32">
      <div className="prose prose-sm sm:prose-base prose-slate max-w-none text-muted-foreground prose-headings:text-foreground prose-a:text-primary">
        ...
        <p>Vertretungsberechtigte Personen: Max Mustermann</p>
        <p>
          E-Mail: <a href="mailto:info@trustolino.de">info@trustolino.de</a>
        </p>
        <p>
          Impressum:{" "}
          <Link to="/impressum">https://www.trustolino.de/impressum</Link>
        </p>
        ...
        <h2 id="m239">Anfrage- und Vorregistrierungsformular</h2>
        <p>
          Auf unserer Website bieten wir die Möglichkeit an, sich über ein Anfrageformular unverbindlich für unsere App "Trustolino" als Betreuer vorzuregistrieren. In diesem Rahmen erfassen wir Ihre Daten, um Ihnen Neuigkeiten über das Projekt zuzusenden und Ihnen zum Release einen exklusiven Coupon-Code zukommen zu lassen.
        </p>
        <ul>
          <li>
            <strong>Verarbeitete Datenarten:</strong> Bestandsdaten (Alter, Geschlecht); Kontaktdaten (E-Mail-Adresse).
          </li>
          <li>
            <strong>Betroffene Personen:</strong> Nutzer unseres Vorregistrierungsformulars (Betreuer).
          </li>
          <li>
            <strong>Zwecke der Verarbeitung:</strong> Zusendung von Neuigkeiten zum Projekt und Versand des Coupon-Codes.
          </li>
          <li>
            <strong>Aufbewahrung und Löschung:</strong> Alle Daten aus der Vorregistrierung werden automatisch 24 Stunden nach dem finalen Versand des Coupon-Codes (nach Ablauf des Countdowns) gelöscht oder unmittelbar nach Erhalt einer Löschanfrage per E-Mail.
          </li>
          <li>
            <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO) sowie vorvertragliche Maßnahmen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO).
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>Zwecke der Verarbeitung und berechtigte Interessen:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit; Informationstechnische Infrastruktur (Betrieb und Bereitstellung von Informationssystemen und technischen Geräten (Computer, Server etc.)). Sicherheitsmaßnahmen.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>Zwecke der Verarbeitung und berechtigte Interessen:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.
          </li>
          <li>
