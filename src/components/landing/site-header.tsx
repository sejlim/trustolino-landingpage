...
export function SiteHeader({ lang }: { lang: Lang }) {
  ...
  return (
    <header className="absolute left-0 right-0 top-0 z-50 flex justify-center px-4 pt-4 sm:px-6">
      <div className="flex w-full max-w-6xl items-center justify-between gap-2 rounded-full border border-border bg-card px-4 py-2.5 sm:gap-4 sm:px-6">
